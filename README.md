...
- [DisplayMergeNub.kext] (This is a custom display EDID and setting injector. It is unlikely that you will have your internal monitor working without this. You can follow these instructions ( to create your own if this one does not work but make sure you follow the instructions carefully as you could end up unable to completely boot)
